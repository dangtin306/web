      ...
      <div  class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
          ...
          <div class='max-w-md mx-auto  space-y-6'>
                ...
                selectpicker sp1 form-control"   @change="onChange()"   name="nhamang" v-model="social">
                  ...
                  <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Chọn dịch vụ (Choose Service )</label>
                  ...
                  Link bài viết ,trang cá nhân cần lấy uid
                    <br>
                    Links post or profiles ,.. get uid
                </label>
                    
<input class="form-control form-control-alternative"  id="inputlienket" v-model="lienketchay" placeholder="Sao chéo liên kết điền vô đây" />
<div v-if="thanhcong">  
      ...
      options3: null ,
        ...
        methods : {
          ...
          xacnhan(){
            ...
            axios
         .post('https://tuongtac.fun/api/layid.php', {
          service: this.theloai ,
