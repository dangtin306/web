<template>
   ...
   <div>
       <p>Chuyển điểm jop instagram sang xu
           trong App <br>
            Số điểm chuyển tối thiểu 7 nghìn <br>
            Phí chuyển điểm 0% ,
            Tỷ giá chuyển 1000 điểm = 15 xu<br>
            Nếu bỏ follow số điểm sẽ giảm
            </p>
   </div>
   <div v-if="info2 == null" class="container-fluid">
 ...
 <div v-else>
   <form @submit="onSubmit" class="add-form">
     ...
     <div class="form-control">
       ...
       <br>
       <input
       class="border-2 border-rose-600 h-10" 
         type="text"
         v-model="amount"
         name="amount"
...
<br>
 ...
 <router-link type="button" to="/cheoig">
