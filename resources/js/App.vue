...
<div class="menu-inner-shadow"></div>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item" style="">
        ...
        <ul class="menu-sub">
        <li>
          <router-link to="/naptien" class="menu-link layout-menu-toggle btn-sm  btn-outline-primary dropdown-item"> <img src="https://tuongtac.fun/img/icon/kimcuong.gif" style="width:20px;height:20px;bg-white ; ">&nbsp; Nạp tiền
      ...
      <li class="menu-item ">
        <router-link class="menu-link layout-menu-toggle"  to="/account">
