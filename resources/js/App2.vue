<template>
  ...
  <div  class="tabs">
    ...
    <input @click="tap1" type="radio" name="tab"  id="tab-01"  />
    ...
    <input @click="tap2" type="radio" name="tab" onclick="loading02()" id="tab-02" />
    ...
    <!-- TAB 4 -->
    <input @click="tap4" type="radio" name="tab" onclick="loading04()"  id="tab-04" />
    <label for="tab-04">
      <svg>
...
<div class="menu-inner-shadow"></div>
      ...
      <ul class="menu-inner py-1">
        ...
        <li class="menu-item" style="">
          ...
          <ul class="menu-sub">
          <li>
            <router-link to="/naptien" class="menu-link layout-menu-toggle btn-sm  btn-outline-primary dropdown-item"> <img src="https://hust.media/img/icon/nap.webp " style="width:20px;height:20px;bg-white ; "> Nạp tiền
          <i class="ni ni-check-bold"></i>
        </router-link>
          <a href="https://hust.media/ruttien.php" class="menu-link layout-menu-toggle btn-sm  btn-outline-primary dropdown-item"> <img src="https://hust.media/img/icon/nap.webp " style="width:20px;height:20px;bg-white ; "> Rút tiền
        ...
        <li class="menu-item ">
          ...
          <img src="https://hust.media/img/icon/telegram.png" style="width:27px;height:27px">
