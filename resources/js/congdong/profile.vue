    ...
    <div class="relative max-w-2xl mx-auto my-3">
        ...
        <!-- <div class="flex justify-between items-center text-sm">
            ...
            <a href="#" class="flex gap-1 items-center">
                <span class="font-bold">Tính năng đang phát triển</span>
        ...
        <div class="flex flex-col justify-center items-center my-5">
            ...
            <span class="my-3">Tính năng đang phát triển</span>
            ...
            <p class="mb-3">Tính năng tạo profile sẽ sớm có trong thời gian sớm nhất</p>
        </div>
        <!-- top header end -->
