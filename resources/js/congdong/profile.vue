<template>
    ...
    <div class="mx-2 py-2 bg-green-300 shadow-lg pb-3 rounded-b-3xl">
        <div class="flex  rounded-b-3xl bg-gray-100 dark:bg-gray-700 space-y-5 flex-col items-center py-7">
            <span @click="saochep(username)" class="text-h1">{{ username }} </span>
        </div>
        <div class="grid px-7 py-2  items-center justify-around grid-cols-4 gap-4 divide-x divide-solid ">
            ...
            <div class="col-span-1 px-3 flex flex-col items-center ">
                <span class="text-2xl font-bold dark:text-gray-500">
                    {{ limit }}</span>
                <span class="text-lg font-medium">Hạn mức</span>
            </div>
        </div>
        ...
        <div class='mt-4 mx-2 items-center justify-center from-teal-100 via-teal-300 to-teal-500 '>
            ...
            <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                ...
                <div class='max-w-md mx-auto  space-y-6'>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <label for="countries2"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Chọn lựa
                                chọn</label>
                    ...
                    <input class="form-control form-control-alternative" v-model="lienketchay"
                        placeholder="Nhập cái bạn cần nhé =)))" />
                    <div v-if="thanhcong">
    ...
    <div
        ...
        <div class="col-span-1  p-3">
            <div @click="click('username')" class="flex flex-col items-center ">
                <button class="tr-300">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 text-gray-500" fill="none" viewBox="0 0 24 24"
        ...
        <div class="col-span-1  p-3">
            <div class="flex flex-col items-center ">
                <div @click="click('password')"> <button class="tr-300">
        ...
        <div class="col-span-1  p-3">
            <div class="flex flex-col items-center ">
                <div @click="click('aoikey')"><button class="tr-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 text-gray-500" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="col-span-1  p-3">
            <div class="flex flex-col items-center ">
                <a href="https://hust.media/profile/#here">
                    <button class="tr-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 text-gray-500" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
...
export default {
    ...
    methods: {
        ...
        testFunction5(response) {
            ...
            this.info = response.data,
                this.namelevel = this.info.namelevel
            this.limit = this.info.limit
        }
    }
}
