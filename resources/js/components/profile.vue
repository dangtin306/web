      ...
      <div class="header">
        ...
        <div class="stats">
          <span class="stat-module">
            Số chap <span class="stat-number">đang cập nhật</span>
          </span>
          <span class="stat-module">
            Lượt xem <span class="stat-number">đang cập nhật</span>
          </span>
          <span class="stat-module">
            Trạng thái <span class="stat-number">đang cập nhật</span>
          </span>
        </div>
      </div> <!-- END header -->
    </div>
