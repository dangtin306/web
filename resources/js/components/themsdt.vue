<template>
  ...
  <div class="max-h-16 ">
    <div class="cards">
      ...
      <Adsense data-ad-client="ca-pub-4574266110812955" data-ad-slot="1627514116" data-full-width-responsive="no"
  ...
  <div class="fixrow row">
    <div v-if="status2 != 1 && status2 != 3">
      <div class="col-xl-4 mt-0">
        <div class='mt-1 mx-2 items-center justify-center from-teal-100 via-teal-300 to-teal-500 '>
          ...
          <div class='w-full max-w-lg px-10 py-6 mx-auto bg-white rounded-lg shadow-xl'>
            <form>
    ...
    focus:ring-gray-800 ring-gray-400 ring focus:ring-offset-2 focus:ring-offset-white dark:border-gray-600 dark:bg-primary-darker
     dark:focus:ring-offset-dark-eval-1 block w-full" id="name2" name="name2" required="required" v-model="name2"
                ...
                <button v-if="urlsdt != '/profile' && urlsdt != '/momo' && urlsdt != 'https://hust.media/ruttien.php'"
                  type='submit' @click="onSubmit"
                  class='flex break-inside bg-black rounded-3xl px-8 py-2 mb-1 w-full dark:bg-slate-800 dark:text-white'>
                  <div class='flex items-center justify-between flex-1'>
                    <span class='text-lg font-medium text-white'>{{ buttonthemso }}</span>
    ...
    <div v-if="message">
      <div class="col-xl-4 mt-0">
        <div class='flex items-center py-7 flex-col mx-2 '>
          <div
            class='break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-[#5E17F4] text-white'>
